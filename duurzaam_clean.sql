...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 28 jan 2026 om 09:17
...
CREATE TABLE `artikel` (
  ...
  `datum_ingevoerd` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE `planning` (
  ...
  `adres_bezorg_ophaal` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `voorraad` (
  ...
  `prijs_ex_btw` decimal(10,2) NOT NULL,
  `ingeboekt_op` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- AUTO_INCREMENT voor een tabel `wagen`
--
ALTER TABLE `wagen`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `planning`
  ...
  ADD CONSTRAINT `planning_ibfk_3` FOREIGN KEY (`wagen_id`) REFERENCES `wagen` (`id`),
  ADD CONSTRAINT `planning_ibfk_4` FOREIGN KEY (`persoon_id`) REFERENCES `personen` (`id`);
